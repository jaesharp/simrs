...
//!
//! // Cross-validated against swsim gsm_algo()
//! let ki   = [0xABu8; 16];
//! let rand = [0xCDu8; 16];
//!
...
///
/// Bit-identical output to swsim's `gsm_algo()`, verified by compiling and
/// running the C reference implementation.
///
/// ```
/// use simrs_comp128::comp128;
///
...
mod tests {
    ...
    // -- Cross-validation vectors (generated by compiling swsim gsm_algo()) --
...
mod proptests {
    ...
    proptest! {
        ...
        #[test]
        fn deterministic(ki in any::<[u8; 16]>(), rand in any::<[u8; 16]>()) {
            prop_assert_eq!(comp128(&ki, &rand), comp128(&ki, &rand));
        }
    }
