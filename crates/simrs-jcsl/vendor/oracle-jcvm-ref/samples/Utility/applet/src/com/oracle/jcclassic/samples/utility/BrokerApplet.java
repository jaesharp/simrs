...
package com.oracle.jcclassic.samples.utility;
...
public class BrokerApplet extends Applet {
    ...
    /**
     * constructed BER TLV Tag stock information
     */
    ConstructedBERTag stockInfoTag;

    /**
     * constructed BER TLV Tag for sale stock request for broker
     */
    ...
    /**
     * constructed BER TLV Tag for sale stock confirmation from broker
     */
    ...
    private byte genStockPurchaseRequest(byte[] buffer) {
        ...
        // first 5 bytes contain the stock symbol with each byte representing
        // an ASCII value
        offset += (short) 5;
        ...
        Util.arrayCopyNonAtomic(buffer, ISO7816.OFFSET_CDATA, scratchSpace, offset, STOCK_SYMBOL_LENGTH);
    ...
    private byte genSellStockRequest(byte[] buffer) {
        ...
        stockSymbol.toBytes(scratchSpace, (short) 0);
     ...
     *
     */
    void verifyBrokerSignature(byte[] buffer) {
        // get the stock price
        signatureTag.toBytes(scratchSpace, (short) 0);
        short sigTLVOffset = ConstructedBERTLV.find(buffer, ISO7816.OFFSET_CDATA, scratchSpace, (short) 0);
    ...
    /**
     * As a result of a stock that is bought, we create a new TLV to hold the
    ...
    private ConstructedBERTLV createNewStockTLV(byte[] buffer, short symbolOffset, short numOffset, short priceOffset) {
        ...
        short offset;
        stockInfoTag.toBytes(scratchSpace, (short) 0);
