...
package com.oracle.jcclassic.samples.signaturemessagerecovery;
...
public class SigMsgRecApplet extends Applet {
     ...
     */
    protected SigMsgRecApplet(byte[] bArray, short bOffset) {
    ...
    public static void install(byte[] bArray, short bOffset, byte bLength) {
        new SigMsgRecApplet(bArray, bOffset);
    }
    ...
    private void testCryptoVerifyFullMsgRecovery(APDU apdu) {
        ...
        sig.beginVerify(sigBuff, (short) 0, bytesRead);
    ...
    private void testCryptoVerifyPartMsgRecovery(APDU apdu) {
        ...
        if (recState == 0) {
            ...
            // consume the recoverable message. Then discard it
