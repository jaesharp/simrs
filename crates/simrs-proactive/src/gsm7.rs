//! GSM 7-bit default alphabet pack/unpack per 3GPP TS 23.038.
//!
...
//!
//! # Standards
//! - 3GPP TS 23.038 V17.0.0 clause 6.1.2 -- GSM 7 bit Default Alphabet
//! - 3GPP TS 23.038 V17.0.0 clause 6.1.2.1 -- Packing of 7-bit characters
...
///
/// Per 3GPP TS 23.038 clause 6.2.1, Table 6.2.1.
...
///
/// Per 3GPP TS 23.038 Table 6.2.1. Note that `@` maps to GSM code `0x00`.
///
/// # Example
///
/// ```
...
///
/// Codes 0x00--0x7F are mapped per 3GPP TS 23.038 Table 6.2.1.
/// Codes >= 0x80 return `b'?'`.
///
/// # Example
///
...
/// The 7-bit codes are then packed into octets per 3GPP TS 23.038 clause 6.1.2.1.
///
...
mod tests {
    ...
    fn ascii_to_gsm7_at_sign() {
        // @ = GSM code 0x00 per 3GPP TS 23.038
