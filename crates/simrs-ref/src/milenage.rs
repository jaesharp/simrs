//! Milenage reference test vectors per ETSI TS 135 208.
//!
...
/// Returns all ETSI TS 135 208 test vectors.
#[inline]
pub fn vectors() -> &'static [MilenageVector] {
    &VECTORS
}

/// ETSI TS 135 208 Test Sets 1--6.
static VECTORS: [MilenageVector; 6] = [
    // Test Set 1 (TS 135 208 clause 5.1)
    MilenageVector {
        k: [
    ...
    // Test Set 2 (TS 135 208 clause 5.2)
    MilenageVector {
        k: [
    ...
    // Test Set 3 (TS 135 208 clause 5.3)
    MilenageVector {
        k: [
    ...
    // Test Set 4 (TS 135 208 clause 5.4)
    MilenageVector {
        k: [
    ...
    // Test Set 5 (TS 135 208 clause 5.5)
    MilenageVector {
        k: [
    ...
    // Test Set 6 (TS 135 208 clause 5.6)
    MilenageVector {
        k: [
...
mod tests {
    ...
    fn all_vectors_match() {
        for (i, v) in VECTORS.iter().enumerate() {
            let p = MilenageParams::with_defaults(v.k, OperatorVariant::Opc(v.opc));
            assert_eq!(
            ...
            assert_eq!(
                p.compute_cipher_key(&v.rand), v.expected_f3,
                "Test Set {} f3 (CK) mismatch", i + 1
            );
            assert_eq!(
                p.compute_integrity_key(&v.rand), v.expected_f4,
