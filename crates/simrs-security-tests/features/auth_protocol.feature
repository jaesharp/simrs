...
#
# Standards:
#   3GPP TS 31.102 V19.4.0  clause 7.1.2   (AUTHENTICATE command)
#   3GPP TS 33.102 V19.1.0  clause 6.3     (AKA authentication and key agreement)
#   3GPP TS 35.205 V19.0.0                 (Milenage algorithm spec)
#   ETSI TS 102 221 V18.3.0 clause 11.1.10 (AUTHENTICATE)
#   GSM 11.11 / 3GPP TS 51.011 V4.15.0 clause 9   (RUN GSM ALGORITHM, INS=0x88, P2=0x00)
#
