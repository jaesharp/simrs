...
use simrs_jcvm_opcodes::{
    AALOAD, AASTORE, ALOAD, ALOAD_0, ANEWARRAY, ARETURN, ARRAYLENGTH, ARRAY_TYPE_BYTE,
    ARRAY_TYPE_INT, ARRAY_TYPE_SHORT, ASTORE, ASTORE_0, BALOAD, BASTORE, BSPUSH, GETFIELD_A,
    GETFIELD_B, GETFIELD_I, GETFIELD_S, GOTO, I2B, I2S, IADD, IALOAD, IAND, IASTORE, ICMP,
    ICONST_0, IDIV, IFEQ, IFGE, IFGT, IFLE, IFLT, IFNE, IFNONNULL, IFNULL, IF_ACMPEQ, IF_ACMPNE,
    IF_SCMPEQ, IF_SCMPGE, IF_SCMPGT, IF_SCMPLE, IF_SCMPLT, IF_SCMPNE, IINC, IIPUSH, ILOAD, ILOAD_0,
