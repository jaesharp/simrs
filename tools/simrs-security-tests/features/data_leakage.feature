...
#   ETSI TS 102 221 V18.3.0  clause 11.1.2  (GET RESPONSE)
#   ETSI TS 102 221 V18.3.0  clause 11.1.1.3 (FCP template structure)
#   3GPP TS 31.102 V19.4.0   clause 11.2.1  (SELECT response for USIM)
#
# Vulnerability model:
